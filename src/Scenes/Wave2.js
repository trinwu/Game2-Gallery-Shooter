class Wave2 extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.ghostShotFrequency % 20 == 0 && this.ghost.visible){
            let slimeToPush = this.add.sprite(this.ghost.x, this.ghost.y-(this.ghost.displayHeight/2), "slime");
        ...
        for (let bullet of my.sprite.bullet) {
            if(this.collides(this.ghost, bullet)){
                bullet.y = -100;
